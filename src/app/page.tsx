      ...
      <section ref={heroRef} id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-28 sm:py-32">
        ...
        <picture className="absolute inset-0 w-full h-full pointer-events-none">
          ...
          <img
            ...
            className="w-full h-full object-cover object-center transform-gpu brightness-[1.18] contrast-[1.03] transition-all duration-300"
            loading="eager"
            decoding="async"
          />
        </picture>
        {/* Dark gradient overlay — lighter across mobile and desktop for crystal clear background visibility */}
        <div className="absolute inset-0 z-[1] opacity-75 sm:opacity-80 md:opacity-85 transition-opacity duration-300" style={{
